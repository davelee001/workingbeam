...
[Live Demo](https://workingbeam-demo.onrender.com) | [GitHub](https://github.com/davelee001/workingbeam) | [Architecture](#architecture)
...
The frontend and backend are ready for Render through `render.yaml`.
...
The `workingbeam-demo` static site builds the React client, rewrites application routes to `index.html`, and sends API requests to `workingbeam-api`. Sync the Blueprint in Render to provision or update both services.
